...
3. Press **Ctrl-Shift-G** to open source control and click on Clone Repository.  Copy this link : https://github.com/JohannesLi10m/CS3_1stQtrPortfolio.git
...
3. **Type the following:**
   - git init
   - git config --global user.JohannesLi10m 
   - git config --global user.b2029jsadelacruz@pshs.edu.ph
